...
public class MCMBiomeProvider extends BiomeSource {

    public static final Codec<MCMBiomeProvider> CODEC = RegistryOps.retrieveRegistry(Registry.BIOME_REGISTRY)
            .xmap(MCMBiomeProvider::new, MCMBiomeProvider::getBiomeRegistry).codec();

    private final Holder<Biome> biome;
    private final Registry<Biome> biomeRegistry;
    private static final List<ResourceKey<Biome>> SPAWN = Collections.singletonList(Biomes.PLAINS);

    public MCMBiomeProvider(Registry<Biome> biomeRegistry) {
