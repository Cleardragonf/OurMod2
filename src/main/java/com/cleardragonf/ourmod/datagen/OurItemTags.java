...
public class OurItemTags extends ItemTagsProvider {
    ...
    protected void addTags(){
        tag(Tags.Items.ORES)
                ...
                .add(Registration.COBALT_ORE_DEEPSLATE_ITEM.get())
                ...
                .add(Registration.SILVER_ORE_DEEPSLATE_ITEM.get())
                .add(Registration.ALUMINIUM_ORE_OVERWORLD_ITEM.get())
                .add(Registration.ALUMINIUM_ORE_DEEPSLATE_ITEM.get())
                .add(Registration.MAGNESIUM_ORE_OVERWORLD_ITEM.get())
                .add(Registration.MAGNESIUM_ORE_DEEPSLATE_ITEM.get())
                .add(Registration.NICKEL_ORE_OVERWORLD_ITEM.get())
                .add(Registration.NICKEL_ORE_DEEPSLATE_ITEM.get())
                .add(Registration.ZINC_ORE_OVERWORLD_ITEM.get())
                .add(Registration.ZINC_ORE_DEEPSLATE_ITEM.get())
                .add(Registration.PHOSPHATE_ORE_OVERWORLD_ITEM.get())
                .add(Registration.PHOSPHATE_ORE_DEEPSLATE_ITEM.get())
                .add(Registration.SALT_ORE_OVERWORLD_ITEM.get())
                .add(Registration.SALT_ORE_DEEPSLATE_ITEM.get());
