...
public class OurItemModels extends ItemModelProvider {
    ...
    protected void registerModels(){
        ...
        withExistingParent(Registration.COBALT_ORE_DEEPSLATE_ITEM.get().getRegistryName().getPath(), modLoc("block/cobalt_ore_deepslate"));
        ...
        withExistingParent(Registration.SILVER_ORE_DEEPSLATE_ITEM.get().getRegistryName().getPath(), modLoc("block/silver_ore_deepslate"));
        ...
        withExistingParent(Registration.ALUMINIUM_ORE_DEEPSLATE_ITEM.get().getRegistryName().getPath(), modLoc("block/aluminium_ore_deepslate"));
        ...
        withExistingParent(Registration.MAGNESIUM_ORE_DEEPSLATE_ITEM.get().getRegistryName().getPath(), modLoc("block/magnesium_ore_deepslate"));
        withExistingParent(Registration.NICKEL_ORE_OVERWORLD_ITEM.get().getRegistryName().getPath(), modLoc("block/nickel_ore_overworld"));
        withExistingParent(Registration.NICKEL_ORE_DEEPSLATE_ITEM.get().getRegistryName().getPath(), modLoc("block/nickel_ore_deepslate"));
        withExistingParent(Registration.ZINC_ORE_OVERWORLD_ITEM.get().getRegistryName().getPath(), modLoc("block/zinc_ore_overworld"));
        withExistingParent(Registration.ZINC_ORE_DEEPSLATE_ITEM.get().getRegistryName().getPath(), modLoc("block/zinc_ore_deepslate"));
        withExistingParent(Registration.PHOSPHATE_ORE_OVERWORLD_ITEM.get().getRegistryName().getPath(), modLoc("block/phosphate_ore_overworld"));
        withExistingParent(Registration.PHOSPHATE_ORE_DEEPSLATE_ITEM.get().getRegistryName().getPath(), modLoc("block/phosphate_ore_deepslate"));
        withExistingParent(Registration.SALT_ORE_OVERWORLD_ITEM.get().getRegistryName().getPath(), modLoc("block/salt_ore_overworld"));
        withExistingParent(Registration.SALT_ORE_DEEPSLATE_ITEM.get().getRegistryName().getPath(), modLoc("block/salt_ore_deepslate"));
