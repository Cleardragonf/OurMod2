...
public class OurBlockTags extends BlockTagsProvider {
    ...
    protected void addTags(){
        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(Registration.PHOSPHATE_ORE_OVERWORLD.get())
                .add(Registration.SALT_ORE_OVERWORLD.get())
                .add(Registration.COBALT_ORE_DEEPSLATE.get())
                .add(Registration.PLATINUM_ORE_DEEPSLATE.get())
                .add(Registration.SILVER_ORE_DEEPSLATE.get())
                .add(Registration.ALUMINIUM_ORE_DEEPSLATE.get())
                .add(Registration.MAGNESIUM_ORE_DEEPSLATE.get())
                .add(Registration.NICKEL_ORE_DEEPSLATE.get())
                .add(Registration.ZINC_ORE_DEEPSLATE.get())
                .add(Registration.PHOSPHATE_ORE_DEEPSLATE.get())
                .add(Registration.SALT_ORE_DEEPSLATE.get())
                ...
                .add(Registration.SMELTERY_BATTERY_MODULE.get())
